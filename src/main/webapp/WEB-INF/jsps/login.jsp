...
<html lang="en">
  ...
  <body>
    ...
    <p/>
    v11 Live with Rama/Greg - new change 2- Playback Login to IBM Stock Trader (Running on: <%= System.getProperty("os.name")%> ver.:<%= System.getProperty("os.version")%> arch:<%= System.getProperty("os.arch")%>)
    <form method="post"/>
      <table>
        <tr>
